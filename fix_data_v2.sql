-- Step 1: Fix AGUS YASIN's URL (duplicate profile/235 -> correct profile/236)
UPDATE persons SET url = 'https://app.silsilahku.com/masakhzab/det/profile/236/2' WHERE id = 1759;
